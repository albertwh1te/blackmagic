...
from menu.models import TreeMenu,Menu
...
class Query(models.Model):
    ...
    menu_type = models.ForeignKey(Menu,related_name='menus',blank=True,null=True)
    #  description = models.TextField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now=True)
    modifiedtime = models.DateTimeField(auto_now_add=True)
    created_by_user = models.ForeignKey(
        User, null=True, blank=True, related_name='func_creater')
    mender = models.ForeignKey(
        User, null=True, blank=True, related_name='func_mender')

    #  created_at = models.DateTimeField(auto_now_add=True)
    #  last_run_date = models.DateTimeField(auto_now=True)
    #  snapshot = models.BooleanField(default=False, help_text="Include in snapshot task (if enabled)")
    activate = models.BooleanField(default=False, help_text="activate task (if enabled)")
